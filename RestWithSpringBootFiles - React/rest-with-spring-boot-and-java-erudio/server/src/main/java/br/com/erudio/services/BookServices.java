...
public class BookServices {
	...
	public PagedModel<EntityModel<BookVO>> findBookByName(String title, Pageable pageable) {
		
		logger.info("Findin all books");
		
		var bookPage = repository.findBooksByName(title, pageable);
