...
public class BookController {
	...
	@GetMapping(value = "/findBooksByName/{title}", produces = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML })
	...
	public ResponseEntity<PagedModel<EntityModel<BookVO>>> findBooksByName (
			...
			@RequestParam(value = "direction", defaultValue = "asc") String direction)
	{
		...
		Pageable pageable = PageRequest.of(page, size, Sort.by(sortDirection, "title"));
		return ResponseEntity.ok(service.findBookByName(title, pageable));
	}
