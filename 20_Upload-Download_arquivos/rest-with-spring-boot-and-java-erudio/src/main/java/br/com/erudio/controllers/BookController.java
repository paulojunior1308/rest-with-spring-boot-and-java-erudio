...
public class BookController {
	...
	//private BookVOServices service = new BookVOServices();
	...
	@Operation(summary = "Adds a new Book", description = "Add a new Book by passing in a JSON, XML or YML representation of the Book", 
		tags = { "Book" }, 
		responses = {
			@ApiResponse(description = "Success", responseCode = "200", 
				content = @Content(schema = @Schema(implementation = BookVO.class))
